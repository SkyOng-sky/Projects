<?php
    ...
    if (isset($_SESSION['user_id'])) {
        ...
        $sql = "
            SELECT teacher_id, teacher_email, teacher_name, teacher_password 
            FROM teacher
            WHERE teacher_id = ?
        ";
        ...
        if ($stmt = $conn->prepare($sql)) {
            ...
            $stmt->execute();
            $stmt->bind_result($teacherID, $teacherEmail, $teacherName, $teacherPW); 

            if ($stmt->fetch()) {
                $_SESSION['teacherName'] = $teacherName;
                $_SESSION['teacherID'] = $teacherID;
                $_SESSION['teacherPW'] = $teacherPW;
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST') {
        ...
        if ($existingPassword !== $_SESSION['teacherPW']) {
            ...
            if ($stmt = $conn->prepare($sql)) {
                $stmt->bind_param("si", $newPassword, $_SESSION['teacherID']);
                if ($stmt->execute()) {
                    $_SESSION['success'] = "Password updated successfully!";
                    $_SESSION['teacherPW'] = $newPassword;
                } else {
        ...
        header("Location: TeaProfilePage.php?page_before_profile=".$PageBeforeProfile);
        exit();
    }
    ...
    *{
        ...
        <div style="float:right; padding-right:40px;">
            <div class="dropdown">
                ...
                <div id="myDropdown" class="dropdown-content">
                    ...
                    <a href="logoutPage.php?page_before_logout=TeaProfilePage.php"> 
    ...
    <div class="container">
        ...
        <div class="profile-details col-9">
            <div class="profilename"><?php echo htmlspecialchars($_SESSION['teacherName']); ?></div>
                <table style="width:100%;">
                        <tr>
                            <td class="column1 value">Teacher ID</td>
                            <td class="column2" style="font-weight: bold;">:</td>
                            <td class="column3 highlighted-value"><?php echo htmlspecialchars($_SESSION['teacherID']); ?></td>
                        </tr>
                        <tr>
                            <td class="column1 value">Teacher Email</td>
                            <td class="column2" style="font-weight: bold;">:</td>
                            <td class="column3 highlighted-value"><?php echo htmlspecialchars($_SESSION['teacherEmail']); ?></td>
                        </tr>
                        <tr>
    ...
    <script>
        function teaHP(){
        window.location.href="TeaMainPage.php?user_id=<?php echo $_SESSION['user_id']; ?>";
        }
