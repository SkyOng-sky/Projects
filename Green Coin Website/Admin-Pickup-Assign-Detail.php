        ...
        if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['action'])) {
            if ($_POST['action'] === 'assign_points') {
                ...
                try {
                    $update_request = "UPDATE pickup_request 
                                        SET status = 'Completed', admin_id = '$admin_id',
                    ...
                    $notificationQuery = "INSERT INTO user_notification(user_id, datetime, title, announcement, status, admin_id) 
                                        VALUES ('$user_id', NOW(), 'Pickup Completed & Points Awarded ✅ ', '$announcement', 'unread', '$admin_id')";
            ...
            if ($_POST['action'] === 'absent') {
                ...
                $update_query = "UPDATE pickup_request 
                                 SET status = 'Absent', admin_id = '$admin_id',
