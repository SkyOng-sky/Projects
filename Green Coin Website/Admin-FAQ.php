<?php
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST') {
        if (isset($_POST['add_faq'])) {
            ...
            $query = "INSERT INTO faq (question, answer, category, admin_id) VALUES ('$question', '$answer', '$category', '$admin_id')";
...
<div class="container" style="height: 100vh; padding:0px;">
    ...
    <main class="main-content" style="padding: 40px 68px 20px;">
    ...
    <form class="modal-content" action="#" method="post">
        ...
        <div class="container">
            ...
            <div class="modal-body">
                ...
                <textarea id="faq_question" name="faq_question" required style="height: 80px;"></textarea><br><br>
                <label>Answer</label>
        ...
        <form id="editFAQForm" class="modal-content" action="#" method="post">
            ...
            <div class="container">
                ...
                <div class="modal-body">
                    ...
                    <label>Question</label>
                    <textarea id="edit_faq_question" name="faq_question" required style="height: 80px;"></textarea><br><br>

                    <label>Answer</label>
                    <textarea id="edit_faq_answer" name="faq_answer" required style="height: 110px;"></textarea><br><br>
                </div>
