        ...
        echo "<script>
                document.addEventListener('DOMContentLoaded', function() {
                    ...
                    setTimeout(function() {
                        ...
                        window.location.href = 'User-Review.php?page-nr=1';
                    }, 4000); 
                });
            </script>";
...
<body>
    <header>
        ...
        <ul class="nav-links">
            ...
            <li><a onclick="window.location.href='User-Review.php?page-nr=1'">Review</a></li>
        ...
        <div class="right-container">
            ...
            <div class="reward-History">
                <div class="all-record">
                    <?php 
                        $getPointHistoryQuery = mysqli_query($conn, "SELECT dr.dropoff_id AS transaction_id, dr.datetime_submit_form AS transaction_date, 
            ...
            <?php 
                $getRecyleHistoryQuery = mysqli_query($conn, "SELECT dr.dropoff_id AS transaction_id, 
                                                            dr.datetime_submit_form AS transaction_date, dr.status AS status, 
