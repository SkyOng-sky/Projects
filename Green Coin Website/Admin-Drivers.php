...
function uploadToGoogleDrive($fileTmpName, $fileName) {
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['submit'])) {
        ...
        $sql="INSERT INTO driver (driver_name, contact_no, email, age, gender, address, number_plate, driver_image, driver_license_image,status, admin_id)
                VALUES ('$name', '$contact', '$email', '$age', '$gender', '$address', '$number_plate', '$fileID', '$fileID2','Available', '$admin_id')";
