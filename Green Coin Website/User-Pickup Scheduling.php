<?php
    ...
    if (!file_exists('keen-diode-454703-r9-8779d44b19b5.json')) {
...
<body>
   ...
   <center>
        <div class="stickman-container">
            ...
            <div class="education-div">
                <div class="education-title">
                    <h6>DID YOU KNOW?</h6>
                    <h3>What Are The Problems With Electronic Waste?</h3>
                    <!-- <p>
            ...
            <div class="row">
                ...
                <div class="col" id="navigation">
                    ...
                    <div class="footer-nav">
                        ...
                        <a onclick="window.location.href='User-Review.php?page-nr=1'">Review</a>
    ...
    <script>
        ...
        function adjustDateContainerHeights() {
