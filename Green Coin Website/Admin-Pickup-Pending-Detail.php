        ...
        if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['action'])) {
            if ($_POST['action'] === 'assign_driver') {
                ...
                $update_query = "UPDATE pickup_request 
                                SET driver_id = '$driver_id', status = 'Assigned', admin_id = '$admin_id'
                ...
                if (mysqli_query($con, $update_query)) {
                    ...
                    $notificationQuery = "INSERT INTO user_notification(user_id, datetime, title, announcement, status, admin_id) 
                                        VALUES ('$user_id', NOW(), 'Pickup Request Approved! 🚛 ', '$announcement', 'unread', '$admin_id')";
            ...
            if ($_POST['action'] === 'reject_request') {
                ...
                try {
                    ...
                    $announcement = mysqli_real_escape_string($con, $announcement);
                    $notificationQuery = "INSERT INTO user_notification(user_id, datetime, title, announcement, status, admin_id) 
                                        VALUES ('$user_id', NOW(), 'Pickup Request Rejected ❌', '$announcement', 'unread', '$admin_id')";
