<?php
    ...
    function uploadToGoogleDrive($fileTmpName, $fileName) {
        ...
        $client->setAuthConfig('keen-diode-454703-r9-8779d44b19b5.json');
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_FILES["rewardImage"])) {
        ...
        if ($fileID) {
            $sql = "INSERT INTO reward (reward_name, point_needed, reward_image, quantity, status, category, admin_id) 
                    VALUES ('$rewardName', '$rewardPoints', '$fileID', '$rewardStock', 'Available', '$rewardCategory', '$admin_id')";
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['formType']) && $_POST['formType'] === 'approveReward') {
        ...
        $queryUpdate = "
            ...
            SET status = 'Redeemed', location_id = $locationId, collect_datetime = '$currentTime', admin_id = '$admin_id'
