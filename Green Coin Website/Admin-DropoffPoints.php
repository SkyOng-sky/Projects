...
<body>
    ...
    <?php
        ...
        if(empty($centrename) || empty($address) || empty($contact_no) || empty($description)){
            ...
            $sql_insert="INSERT INTO location(location_name,address,contact_no,description,status, admin_id)
            VALUES ('$centrename','$address','$contact_no','$description','Available', '$admin_id')";
